<template>
  <Dashboard :loading="false">
    <template #heading>
      <Heading>
        <slot>
          <h3>{{ $t('dashboard.solution.nftEmailSignupAirdrop.name') }}</h3>
        </slot>
      </Heading>
    </template>
    <slot>
      <div class="pb-8">
        <p class="text-bold my-6">
          <strong>{{ $t('dashboard.solution.nftEmailSignupAirdrop.description') }}</strong>
        </p>
        <div class="mb-8 grid gap-8 border-b border-bg-lighter pb-8 md:grid-cols-2">
          <SolutionContent :content="content">
            <Btn type="primary" href="https://github.com/Apillon/ps-signup-email-airdrop/fork">
          ...
          <div class="flex h-fit justify-center">
            <div class="relative overflow-hidden rounded-lg">
              ...
              <div class="flex-cc absolute bottom-0 left-0 right-0 top-0 bg-bg-dark/75">
                <Btn type="info" size="small" href="https://github.com/Apillon/ps-signup-email-airdrop">
