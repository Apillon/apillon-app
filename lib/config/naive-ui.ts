...
export const themeOverrides: GlobalThemeOverrides = {
  ...
  DataTable: {
    ...
    thColorHoverPopover: `${colors.bg.light}a3`,
    thColorHoverModal: `${colors.bg.light}a3`,
    thColorModal: `${colors.bg.light}a3`,
    thColorPopover: `${colors.bg.light}a3`,
    thColorSorting: `${colors.bg.light}a3`,
    thColorSortingModal: `${colors.bg.light}a3`,
    thColorSortingPopover: `${colors.bg.light}a3`,
    thFontWeight: '600',
